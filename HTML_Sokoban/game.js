...
const languageDict = {
    zh: {
        ...
        maxIterations: "次数",
        maxIterationsDesc: "设置求解器的最大迭代次数（5000-300000）",
        maxNodes: "求解器最大内存节点数",
        maxNodesDesc: "设置求解器的最大内存节点数（5000-300000）",
        wallProb: "墙壁生成概率",
        wallProbDesc: "设置生成墙壁的概率（0.0-1.0）",
        boxProb: "箱子生成概率",
        boxProbDesc: "设置生成箱子和目标点的概率（0.0-1.0）",
        resetDefault: "重置默认",
        save: "保存",
    ...
    en: {
        ...
        maxIterationsDesc: "Set the maximum iterations for the solver (5000-300000)",
        maxNodes: "Solver Maximum Memory Nodes",
        maxNodesDesc: "Set the maximum memory nodes for the solver (5000-300000)",
        wallProb: "Wall Generation Probability",
        wallProbDesc: "Set the probability of generating walls (0.0-1.0), higher values create more complex levels",
        boxProb: "Box Generation Probability",
        boxProbDesc: "Set the probability of generating boxes and targets (0.0-1.0), affects level balance",
